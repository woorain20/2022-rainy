    ...
    <div id="contents">
        <div id="muse">
            {#each museuminfomation as museum}
                {#if museum.photo=="daegu1"}
                    <div id="img">
                        <img src="./src/lib/museumlist/infoimg/{museum.photo}.jpeg" alt="박물관">
                    </div>
                    <div id="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3234.1187172794953!2d128.63632111561506!3d35.84609242851934!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3565e26ca4b17891%3A0x96a30f20da50e8ad!2z6rWt66a964yA6rWs67CV66y86rSA!5e0!3m2!1sko!2skr!4v1659663902513!5m2!1sko!2skr"
                    ...
                    <div id="info">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="tda"><a href="https://daegu.museum.go.kr/" target="_blank">{museum.homepage}</a></td>
                            </tr>
                        </table>
                    </div>
                {/if}                
