    ...
    <div id="contents">
        <div id="muse">
            {#each museuminfomation as museum}
                {#if museum.photo=="chuncheon4"}
                    <div id="img">
                        <img src="./src/lib/museumlist/infoimg/{museum.photo}.jpeg" alt="박물관">
                    </div>
                    <div id="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3149.850924581489!2d127.75028911565384!3d37.863778414806006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3562e5a597d8d089%3A0x56a4908edd7add31!2z6rWt66a97LaY7LKc67CV66y86rSA!5e0!3m2!1sko!2skr!4v1659664804244!5m2!1sko!2skr"
                    ...
                    <div id="info">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="tda"><a href="https://chuncheon.museum.go.kr/" target="_blank">{museum.homepage}</a></td>
                            </tr>
                        </table>
                    </div>
                {/if}                
