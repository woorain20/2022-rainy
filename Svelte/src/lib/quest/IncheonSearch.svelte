<script>
    ...
    onMount(async()=>{
    const res=await fetch("https://apis.data.go.kr/1613000/BusRouteInfoInqireService/getRouteNoList?serviceKey=x0KzQoj%2FBIV99brth41ohqqH0C5620X1PHjoinCE0HLzbf0J99nvL%2FZo3TCCzAbXXPr%2Bw8iS8bomh8QnO9kqpQ%3D%3D&pageNo=1&numOfRows=320&_type=json&cityCode=23")
    bus=await res.json()
    console.log(bus)
    ...
    onMount(async()=>{
    const res=await fetch("https://apis.data.go.kr/1613000/BusSttnInfoInqireService/getSttnNoList?serviceKey=x0KzQoj%2FBIV99brth41ohqqH0C5620X1PHjoinCE0HLzbf0J99nvL%2FZo3TCCzAbXXPr%2Bw8iS8bomh8QnO9kqpQ%3D%3D&pageNo=1&numOfRows=6511&_type=json&cityCode=23")
            ...
            <ul id="inputul">
                <li class="inputli">
                    ...
                    {#each busInfo as info}
                        {#if text==info.routetp.slice(0,2)}
                            <table>
                                <tr>
