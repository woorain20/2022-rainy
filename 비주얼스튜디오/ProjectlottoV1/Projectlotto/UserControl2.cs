...
namespace Projectlotto
{
    public partial class game : UserControl
    {
        ...
        CircularLabel[] labels = new CircularLabel[35];
        Random r = new Random();
        ...
        public game()
        {
            ...
            gameimg1.Visible = false;
            labels[0] = gb11;            labels[1] = gb12;            labels[2] = gb13;            labels[3] = gb14;            labels[4] = gb15;
            labels[5] = gb16;            labels[6] = gb17;            
            labels[7] = gb21;            labels[8] = gb22;            labels[9] = gb23;
            labels[10] = gb24;            labels[11] = gb25;            labels[12] = gb26;            labels[13] = gb27;            
        ...
        {
            gameimg1.Visible = true;
            int[] numbers = new int[6];
            one u = new one(numbers);

            one.Size = new Size(100, 100);
            one.Location = new Point(0, 0);
            gameimg1.Controls.Add(u);
        }
    }
}
