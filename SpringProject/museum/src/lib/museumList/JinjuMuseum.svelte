    ...
    <div id="contents">
        <div id="muse">
            {#each museuminfomation as museum}
                {#if museum.photo=="jinju1"}
                    <div id="img">
                        <img src="./src/lib/museumlist/infoimg/{museum.photo}.jpg" alt="박물관">
                    </div>
                    <div id="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3260.7049888531305!2d128.07475091560303!3d35.18890476442136!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x356efc1105e054c9%3A0x98c58e57b33ffe59!2z6rWt66a97KeE7KO867CV66y86rSA!5e0!3m2!1sko!2skr!4v1659664240399!5m2!1sko!2skr"
                    ...
                    <div id="info">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="tda"><a href="https://jinju.museum.go.kr/" target="_blank">{museum.homepage}</a></td>
                            </tr>
                        </table>
                    </div>
                {/if}                
