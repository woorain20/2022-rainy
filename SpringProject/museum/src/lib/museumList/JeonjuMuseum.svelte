    ...
    <div id="contents">
        <div id="muse">
            {#each museuminfomation as museum}
                {#if museum.photo=="jeonju4"}
                    <div id="img">
                        <img src="./src/lib/museumlist/infoimg/{museum.photo}.jpg" alt="박물관">
                    </div>
                    <div id="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3235.9442694165086!2d127.08525943157332!3d35.80130146755754!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35703b0242532c17%3A0xb34aa83fc97fbde4!2z6rWt66a97KCE7KO867CV66y86rSA!5e0!3m2!1sko!2skr!4v1659663764288!5m2!1sko!2skr"
                    ...
                    <div id="info">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="tda"><a href="https://jeonju.museum.go.kr/" target="_blank">{museum.homepage}</a></td>
                            </tr>
                        </table>
                    </div>
                {/if}                
